        ...
        <table class="tabela">
          <thead>
            <tr>
              ...
              <th class="text-center">LOCADORA</th>
...
export default {
  ...
  computed: {
    ...
    carroFiltrado() {
      if (this.placa) {
        return this.carrosHistorico.filter((carro) =>
  ...
  methods: {
    ...
    fichaCarro(params) {
      const ficha =
        this.carrosHistorico.find((carro) => carro._id === params) || null;
